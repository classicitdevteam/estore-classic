                                    ...
                                    <div class="row gutters-5 align-items-center">
                                        <div class="col-1">
                                            <div class="row no-gutters align-items-center flex-column aiz-plus-minus">
                                                <button class="btn btn-default" type="button" data-type="plus" data-field="qty-0">
                                                    <i class="material-icons md-plus"></i>
                                                </button>
                                                <input type="text" name="qty-0" id="qty-0" class="col border-0 text-center flex-grow-1 fs-16 input-number" placeholder="1" value="1" min="1" max="499" onchange="updateQuantity(0)">
                                                <button class="btn btn-default" type="button" data-type="plus" data-field="qty-0">
                                        ...
                                        <div class="col-3">
                                            <div class="fs-12 opacity-60">${price} x 1</div>
                                            <div class="fs-15 fw-600">${price}</div>
                                        </div>
                                        <div class="col-2">
